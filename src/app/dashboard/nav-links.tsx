      ...
      {links.map((link) => {
        return (
          <Link
            ...
            className={`flex h-[48px]  bg-black  text-white grow items-center justify-center gap-2 rounded-md bg-gray-50 p-3 text-sm font-medium hover:bg-sky-100 hover:text-blue-600 md:flex-none md:p-2 md:px-3
